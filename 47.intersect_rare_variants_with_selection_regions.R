...
rare_file <- file.path(
  base,
  "Genetics_Analysis/Functional_annotation/rare_variants/TT_TX_rare_differentiated_variants.tsv"
)
...
out_file <- file.path(
  base,
  "Genetics_Analysis/Functional_annotation/rare_variants/rare_variants_overlap_selection_GWAS.tsv"
)

summary_file <- file.path(
  base,
  "Genetics_Analysis/Functional_annotation/rare_variants/rare_variants_overlap_selection_GWAS_summary.tsv"
)
