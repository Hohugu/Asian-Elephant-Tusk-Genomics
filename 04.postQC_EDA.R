...
fig_dir  <- file.path(base_dir, "PreGWAS/figures_postQC")
tab_dir  <- file.path(base_dir, "PreGWAS/tables_postQC")

dir.create(fig_dir, showWarnings = FALSE, recursive = TRUE)
dir.create(tab_dir, showWarnings = FALSE, recursive = TRUE)

prefix <- file.path(res_dir, "GWAS_qc_maf001_geno005_mind005")
